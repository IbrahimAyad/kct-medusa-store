import {
  ...
  taxRegionLoader
} from "./chunk-LJHSTHAY.js";
import "./chunk-EGRHWZRV.js";
import {
  useReturnReasons
} from "./chunk-4BIQIUOC.js";
import {
  ProgressBar
...
import {
  FilePreview
} from "./chunk-N4L6ZDPR.js";
import "./chunk-SQJS63XZ.js";
import {
  ConditionalTooltip
} from "./chunk-OC57Q4WC.js";
import {
  we
} from "./chunk-I2UAGZ5U.js";
import {
  languages
...
import {
  useLogout
} from "./chunk-ASAFUTMI.js";
import "./chunk-CUGIGQSE.js";
import {
  useTaxRegions
} from "./chunk-EALJ6LYP.js";
import "./chunk-M2YD6SSP.js";
import {
  useProductTypes
} from "./chunk-H7RVGO5V.js";
import {
  useApiKeys
} from "./chunk-DIIJTXZ5.js";
        ...
        children: [
          {
            path: "/",
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            lazy: () => import("./home-KSB2J7CS-3EACIT6Z.js")
          },
          {
            path: "/products",
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-list-L4LRPSR7-KSLSTO6T.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-create-W3YY3DVE-SNA3RY57.js")
                  },
                  {
                    path: "import",
                    lazy: () => import("./product-import-54TGQZ7T-UIMOZ45F.js")
                  },
                  {
                    path: "export",
                    lazy: () => import("./product-export-OOGAPSQX-HHCIGOJR.js")
                  }
                ]
              },
              {
                ...
                errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
                lazy: async () => {
                  const { Breadcrumb, loader } = await import("./product-detail-NVKQD343-PHZ3PTAG.js");
                  return {
                    Component: Outlet,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./product-detail-NVKQD343-PHZ3PTAG.js"),
                    children: [
                      {
                        path: "edit",
                        lazy: () => import("./product-edit-ZTVKSM27-VAHE63CN.js")
                      },
                      {
                        path: "edit-variant",
                        lazy: () => import("./product-variant-edit-UGC7VGTZ-MXESEMZI.js")
                      },
                      {
                        path: "sales-channels",
                        lazy: () => import("./product-sales-channels-PYCWV7AJ-HQUBM4DT.js")
                      },
                      {
                        path: "attributes",
                        lazy: () => import("./product-attributes-347UCFBA-HJKDEXPV.js")
                      },
                      {
                        path: "organization",
                        lazy: () => import("./product-organization-BZCTO25P-YXV24ZIH.js")
                      },
                      {
                        path: "shipping-profile",
                        lazy: () => import("./product-shipping-profile-4BKER74M-FWM54CGL.js")
                      },
                      {
                        path: "media",
                        lazy: () => import("./product-media-OPFY2IHC-B5BIZFZZ.js")
                      },
                      {
                        path: "prices",
                        lazy: () => import("./product-prices-GZZAUOCR-YZ3ZL7H2.js")
                      },
                      {
                        path: "options/create",
                        lazy: () => import("./product-create-option-77Q4VEBG-QJ6EIOAQ.js")
                      },
                      {
                        path: "options/:option_id/edit",
                        lazy: () => import("./product-edit-option-MJORFO4B-H7ZLJN4S.js")
                      },
                      {
                        path: "variants/create",
                        lazy: () => import("./product-create-variant-3GSLKU3L-XHAXN22F.js")
                      },
                      {
                        path: "stock",
                        lazy: () => import("./product-stock-RMNMTMML-T473KARP.js")
                      },
                      {
                        path: "metadata/edit",
                        lazy: () => import("./product-metadata-Q3UCGHUG-QF2LUEJQ.js")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component: Component4, Breadcrumb, loader } = await import("./product-variant-detail-D6OSO3OF-IKZNKNAD.js");
                      return {
                    ...
                    children: [
                      ...
                      {
                        path: "manage-items",
                        lazy: () => import("./product-variant-manage-inventory-items-TLRIGQ5K-QCRQWRS3.js")
                      },
                      {
                        path: "metadata/edit",
                        lazy: () => import("./product-variant-metadata-A7K2H2NO-TUXVAHTZ.js")
                      }
                    ]
                  }
                ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./category-list-PXNKFNWJ-I7RONUCK.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./category-create-WQJY475T-UWK5VOLE.js")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-QCMGDSZ2-5CA4E2WD.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./category-detail-JFIV6UIU-CLFDLYVO.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./category-edit-RKWZPNAB-AWDFGHWT.js")
                  },
                  {
                    path: "products",
                    lazy: () => import("./category-products-UL64IL2O-4SOQCO2W.js")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-QCMGDSZ2-5CA4E2WD.js")
                  ...
                  {
                    path: "metadata/edit",
                    lazy: () => import("./categories-metadata-FS45VNVT-HYYCRYUU.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./order-list-25DOVMQP-RJZYSYDT.js")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./order-detail-442IYDMT-JYKN4UGI.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "fulfillment",
                    lazy: () => import("./order-create-fulfillment-XKU5E76V-XK3CPRFH.js")
                  },
                  {
                    path: "returns/:return_id/receive",
                    lazy: () => import("./order-receive-return-4I2M5W3F-WA544PDY.js")
                  },
                  {
                    path: "allocate-items",
                    lazy: () => import("./order-allocate-items-7HRMJY5V-D2FY33I3.js")
                  },
                  {
                    path: ":f_id/create-shipment",
                    lazy: () => import("./order-create-shipment-BMSAQSHA-GG3WZR23.js")
                  },
                  {
                    path: "returns",
                    lazy: () => import("./order-create-return-COVUYLIG-HTOHBTVV.js")
                  },
                  {
                    path: "claims",
                    lazy: () => import("./order-create-claim-SODPBIJ5-BDNXF5K3.js")
                  },
                  {
                    path: "exchanges",
                    lazy: () => import("./order-create-exchange-LJEM2Z6I-J22O4G3M.js")
                  },
                  {
                    path: "edits",
                    lazy: () => import("./order-create-edit-KEIEV3FC-EBCP53N6.js")
                  },
                  {
                    path: "refund",
                    lazy: () => import("./order-create-refund-WVD26GN3-5YJ2P3TY.js")
                  },
                  {
                    path: "transfer",
                    lazy: () => import("./order-request-transfer-5DGJNMOD-M2XTJO4T.js")
                  },
                  {
                    path: "email",
                    lazy: () => import("./order-edit-email-OPV4ZOS4-VWYGQSLP.js")
                  },
                  {
                    path: "shipping-address",
                    lazy: () => import("./order-edit-shipping-address-UOPCQLGS-LZJTGNX3.js")
                  },
                  {
                    path: "billing-address",
                    lazy: () => import("./order-edit-billing-address-BFHPDCYQ-PZ5YZLIS.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./order-metadata-4IYRANTV-IQDJMIJ7.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./promotion-list-YL47OSLH-CFLQR5LV.js")
              },
              {
                path: "create",
                lazy: () => import("./promotion-create-3TPHAQQX-BOAAVOYZ.js")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./promotion-detail-J2UOHDOW-6H7XM7KO.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./promotion-edit-details-NXAE4DNG-HVGOLBVV.js")
                  },
                  {
                    path: "add-to-campaign",
                    lazy: () => import("./promotion-add-campaign-OCUROIGI-VB3RQQSN.js")
                  },
                  {
                    path: ":ruleType/edit",
                    lazy: () => import("./edit-rules-RVTFTIZK-YQPFZ6PE.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./campaign-list-6K2UJEKS-J4LMYJZB.js"),
                children: []
              },
              {
                path: "create",
                lazy: () => import("./campaign-create-OHYCYUEH-YRBAEVL3.js")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./campaign-detail-XSOXBVZH-TODRBH5S.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./campaign-edit-U6GDSJ6T-OEMCKHT2.js")
                  },
                  {
                    path: "configuration",
                    lazy: () => import("./campaign-configuration-AQW4CUU7-VSQL4DVZ.js")
                  },
                  {
                    path: "edit-budget",
                    lazy: () => import("./campaign-budget-edit-OYTR26B3-SPEDX5DU.js")
                  },
                  {
                    path: "add-promotions",
                    lazy: () => import("./add-campaign-promotions-2L4EPHIM-H47NFC7C.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./collection-list-FB6VQQ5M-KE2PGH3Z.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./collection-create-I5D44ZYM-EKOIDT74.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./collection-detail-7EYTK5KL-EAJDSW77.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./collection-edit-C62YPOSB-J7QR6ONR.js")
                  },
                  {
                    path: "products",
                    lazy: () => import("./collection-add-products-JDYECFXF-KK5N363G.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./collection-metadata-5HHQNOAJ-L7MX7GIW.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./price-list-list-PCH6JHXA-RFTA22JP.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./price-list-create-ZMBTT3NH-4AXIY66E.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./price-list-detail-TCOLSR6L-ZPFIXIR6.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./price-list-edit-RMAPKFMM-SDYR3MPM.js")
                  },
                  {
                    path: "configuration",
                    lazy: () => import("./price-list-configuration-TCVTV62B-MZM64ML7.js")
                  },
                  {
                    path: "products/add",
                    lazy: () => import("./price-list-prices-add-KC74UVGF-7T5M54O2.js")
                  },
                  {
                    path: "products/edit",
                    lazy: () => import("./price-list-prices-edit-ZSFEY2DV-XCMOJ3EJ.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-list-ICD4KNSK-WAIKGRRB.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./customer-create-Y7YFUEFN-HL4QK2NG.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./customer-detail-P5TRS2GY-CJFGQDTC.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./customer-edit-TED44RMQ-CSV3BIAY.js")
                  },
                  {
                    path: "add-customer-groups",
                    lazy: () => import("./customers-add-customer-group-NEJ5SWWR-RBLC3SUN.js")
                  },
                  {
                  ...
                  {
                    path: "metadata/edit",
                    lazy: () => import("./customer-metadata-5QI6BYLW-US5TBVGC.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-group-list-XK52BCPY-VE3VA5PU.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./customer-group-create-NYGVDH5G-CDXG3SJ5.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./customer-group-detail-6LMMTO5B-ZH2TCDCP.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./customer-group-edit-SXI5CIEK-D3Z4ZGRG.js")
                  },
                  {
                    path: "add-customers",
                    lazy: () => import("./customer-group-add-customers-UAOC5XE5-AKVQR3WJ.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./customer-group-metadata-TPKKYDR3-5RYRSH2E.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./reservation-list-3TBLLH4C-LLRJHOMT.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./reservation-create-3OOUH473-SHKVUQMW.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./reservation-detail-7ZZKM4BU-RBFOKWIS.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./edit-reservation-3XTK5CTO-75VMQWBQ.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./reservation-metadata-Q5RBGAOP-5DUHE2GS.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./inventory-list-YAEX6UUE-MQ2OHTYK.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./inventory-create-ZL3UU5LS-ZBCAGW3C.js")
                  },
                  {
                    path: "stock",
                    lazy: () => import("./inventory-stock-EY6WJQVY-FRTPCAEE.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./inventory-detail-67W2UHHQ-W245FVW5.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./edit-inventory-item-AD7WR3V6-BDGSQ2JB.js")
                  },
                  {
                    path: "attributes",
                    lazy: () => import("./edit-inventory-item-attributes-RQPRXE3E-NUUWX756.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./inventory-metadata-7PL5XRCS-PXUSYIJL.js")
                  },
                  {
                    path: "locations",
                    lazy: () => import("./manage-locations-S6D2JUZ6-TTTRCSPR.js")
                  },
                  {
                    path: "locations/:location_id",
                    lazy: () => import("./adjust-inventory-BKL45HGN-ETM2RIHL.js")
                  }
                ]
              }
            ]
        ...
        children: [
          {
            index: true,
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            lazy: () => import("./settings-FQUPXMWF-P3JOFTXR.js")
          },
          {
            path: "profile",
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            lazy: () => import("./profile-detail-WOOZNL66-HDN4MCJ7.js"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./profile-edit-YLVHPLOG-IVHLBVNW.js")
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./region-list-YXUEKTFB-MA3N5XI2.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./region-create-HX7T3NZ5-6OD73WV5.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./region-detail-D4JJLGF6-NFLUZ4PQ.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./region-edit-MVNYECPG-DTHA56O7.js")
                  },
                  {
                    path: "countries/add",
                    lazy: () => import("./region-add-countries-26DFS3K5-SO47HDDB.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./region-metadata-LDGNEFNK-GNTTXQUF.js")
                  }
                ]
              }
            ]
          },
          {
            path: "store",
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            lazy: () => import("./store-detail-DUCILQW7-BMVT6J3I.js"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./store-edit-T4WGFJ6Z-AAWURPWF.js")
              },
              {
                path: "currencies",
                lazy: () => import("./store-add-currencies-IXOGLJKT-7UNSX3VZ.js")
              },
              {
                path: "metadata/edit",
                lazy: () => import("./store-metadata-G5WQCXQV-5JAHRVUN.js")
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./user-list-L2EE2SIO-7RRJLTQC.js"),
                children: [
                  {
                    path: "invite",
                    lazy: () => import("./user-invite-4NYOYD5L-4235CLYX.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./user-detail-CMPPPDW4-44ANEJPG.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./user-edit-IYZ7FBGN-FGOBFTBG.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./user-metadata-32HQPUSZ-5F6IABEL.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./sales-channel-list-QJKG3VN4-LSCGHIZE.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./sales-channel-create-SNVWPMZE-Y4473RMQ.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./sales-channel-detail-K5VNGCHS-AKYMKMSJ.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./sales-channel-edit-SSLBCW4R-KZ5ZMNVW.js")
                  },
                  {
                    path: "add-products",
                    lazy: () => import("./sales-channel-add-products-UPEB7LJJ-UPC6FDF5.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./sales-channel-metadata-QCCR6GPY-IILUH6UV.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./location-list-CYLKB6HD-2Z2XPHJJ.js")
              },
              {
                path: "create",
                lazy: () => import("./location-create-VM7NJPQR-NRCVP3DZ.js")
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./shipping-profiles-list-G3PURS4A-7DIF7APR.js"),
                    children: [
                      {
                        path: "create",
                        lazy: () => import("./shipping-profile-create-ENRP2FPI-RS6BBZ6Y.js")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component: Component4, Breadcrumb, loader } = await import("./shipping-profile-detail-7E5Y3TE7-IEFBN5F3.js");
                      return {
                        Component: Component4,
                        loader,
                        handle: {
                    ...
                    children: [
                      {
                        path: "metadata/edit",
                        lazy: () => import("./shipping-profile-metadata-5ZSX5G2D-C2DNVMQB.js")
                      }
                    ]
                  }
                ]
              },
              {
                path: ":location_id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./location-detail-MPGRHN23-KX2Y6CPB.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./location-edit-V6PUA3QW-TX6BR37V.js")
                  },
                  {
                    path: "sales-channels",
                    lazy: () => import("./location-sales-channels-RIRPFHTF-T2XA4VQE.js")
                  },
                  {
                    path: "fulfillment-providers",
                    lazy: () => import("./location-fulfillment-providers-KS72LDSU-JQFSF3DD.js")
                  },
                  {
                    ...
                    children: [
                      {
                        ...
                        lazy: () => import("./location-service-zone-create-C75LX4EZ-24PCPTMX.js")
                      },
                      {
                        ...
                        children: [
                          {
                            path: "edit",
                            lazy: () => import("./location-service-zone-edit-DS6SJYLK-IHN6O2QH.js")
                          },
                          {
                            path: "areas",
                            lazy: () => import("./location-service-zone-manage-areas-V4FW7KPZ-QQCHWKXN.js")
                          },
                          {
                            ...
                            children: [
                              {
                                path: "create",
                                lazy: () => import("./location-service-zone-shipping-option-create-KHQ4ZOYX-UOKONS34.js")
                              },
                              {
                                path: ":so_id",
                                children: [
                                  {
                                    path: "edit",
                                    lazy: () => import("./location-service-zone-shipping-option-edit-DM5EFDP3-XTIDFN4F.js")
                                  },
                                  {
                                    path: "pricing",
                                    lazy: () => import("./location-service-zone-shipping-option-pricing-IAS6HI3L-MYLFRGBA.js")
                                  }
                                ]
                              }
                            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-tag-list-ZYDV2DPN-XSQAJX6S.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-tag-create-DEXEBAXM-EC5KEIJQ.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./product-tag-detail-OPTTTIGX-NDRB2TFV.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./product-tag-edit-MFBLY44A-YSSAQ7OM.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./workflow-execution-list-2IRP7OES-MZ7OCUEI.js")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./workflow-execution-detail-TD2XBDPN-ZQHON3S3.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-type-list-VYL67JJK-AQF6WPDO.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-type-create-5DUFWSNN-XQN5OAUE.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./product-type-detail-3B6RMAXQ-FDUV7DZN.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./product-type-edit-3Z4W6DUK-JHCA65GL.js")
                  }
                ]
              }
            ]
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./api-key-management-list-DVVRSZMW-ZTYGEI73.js"),
                    children: [
                      {
                        path: "create",
                        lazy: () => import("./api-key-management-create-W6YEAUUP-4A2EUWM3.js")
                      }
                    ]
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./api-key-management-detail-WBWSQB2W-7XOM2YXF.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./api-key-management-edit-TRROTPQ7-LRZAPF5T.js")
                  },
                  {
                    path: "sales-channels",
                    lazy: () => import("./api-key-management-sales-channels-AKHDDKJA-YTOKPLSN.js")
                  }
                ]
              }
            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./tax-region-list-AYS4JBDG-66JVZCLM.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./tax-region-create-34Y47AZV-MHQO735J.js")
                  }
                ]
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: async () => {
                      const { Component: Component4 } = await import("./tax-region-detail-D4IZ477X-O55XWJGI.js");
                      return {
                        Component: Component4
                      };
                    },
                    children: [
                      {
                        ...
                        lazy: () => import("./tax-region-province-create-SWSIZ2S6-PAZ7IS7E.js")
                      },
                      {
                        path: "overrides/create",
                        lazy: () => import("./tax-region-tax-override-create-V5LPJTYD-45P23B6A.js")
                      },
                      {
                        path: "overrides/:tax_rate_id/edit",
                        lazy: () => import("./tax-region-tax-override-edit-7PWKI5ZI-SRORWBMP.js")
                      },
                      {
                        path: "tax-rates/create",
                        lazy: () => import("./tax-region-tax-rate-create-BCQHMSAU-ILRUJ3F5.js")
                      },
                      {
                        path: "tax-rates/:tax_rate_id/edit",
                        lazy: () => import("./tax-region-tax-rate-edit-PBTATWXH-5UUCRQDC.js")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component: Component4, Breadcrumb, loader } = await import("./tax-region-province-detail-GUPRWEB7-4EB2IF2J.js");
                      return {
                        Component: Component4,
                        loader,
                        handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./return-reason-list-XMVB4QQS-HAI7LMER.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./return-reason-create-GZJMCRPO-TWLP6CPR.js")
                  },
                  {
                    path: ":id",
                    children: [
                      {
                        path: "edit",
                        lazy: () => import("./return-reason-edit-CV23YIAF-DJVOIQ6Y.js")
                      }
                    ]
                  }
                ]
    ...
    children: [
      {
        ...
        children: [
          {
            path: "/login",
            lazy: () => import("./login-V3O7N2XA-J3NTI3HB.js")
          },
          {
            path: "/reset-password",
            lazy: () => import("./reset-password-BNC2OI6E-5E6UELQL.js")
          },
          {
            path: "/invite",
            lazy: () => import("./invite-W2J3H5L6-JALEUGG4.js")
          },
          {
            path: "*",
            lazy: () => import("./no-match-YRNHGOT3-L6ZWS6Y2.js")
          }
        ]
      }
    ]
